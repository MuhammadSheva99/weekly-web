...
class WeeklyCommitmentController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($targetMingguanList->isEmpty()) {
            ...
            if ($existingManual) {
                return view('karyawan.weekly-commitment.edit', [
                    'targetMingguan' => null,
                    'mingguKe' => $mingguKe,
            ...
            return view('karyawan.weekly-commitment.create', [
                'targetMingguan' => null,
                'mingguKe' => $mingguKe,
            ]);
        }
        ...
        if ($existing) {
            return view('karyawan.weekly-commitment.edit-multi', [
                'mingguKe' => $mingguKe,
        ...
        return view('karyawan.weekly-commitment.create-multi', [
    ...
    {
        // Mode manual (tanpa KPI ter-assign)
        ...
        return redirect()->route('karyawan.dashboard')->with('status', 'Weekly Commitment berhasil disimpan untuk '.count($data['target_mingguan_ids']).' KPI.');
    }
    ...
    protected function storeManual(Request $request)
    {
        ...
        return redirect()->route('karyawan.dashboard')->with('status', 'Weekly Commitment berhasil disimpan.');
    }
    ...
    public function update(Request $request, WeeklyCommitment $commitment)
    {
        ...
        if (! $commitment->target_mingguan_id) {
            ...
            return redirect()->route('karyawan.weekly-commitment.create')->with('status', 'Weekly Commitment berhasil diperbarui.');
        }
