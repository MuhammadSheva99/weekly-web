...
class SelfReviewController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($sudahReview) {
            return view('karyawan.self-review.edit-multi', ['commitments' => $commitments]);
        }

        return view('karyawan.self-review.create-multi', ['commitments' => $commitments]);
    }
    ...
    public function store(Request $request)
    {
        ...
        foreach ($data['weekly_commitment_ids'] as $commitmentId) {
            ...
            // Kunci Actual Mingguan per KPI — ini yang trigger ActualMingguanObserver
            // buat SEMUA KPI dalam batch, bukan cuma 1
        ...
        return redirect()->route('karyawan.dashboard')->with('status', 'Self Review berhasil disimpan untuk '.count($data['weekly_commitment_ids']).' KPI. Data actual mingguan sudah terkunci.');
    }
