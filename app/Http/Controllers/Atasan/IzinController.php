...
class IzinController extends Controller
{
    public function dashboard()
    {
        ...
        return view('atasan.izin.dashboard', [
    ...
    {
        return view('atasan.izin.ajukan', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('atasan.izin.dashboard')->with('status', 'Pengajuan izin berhasil dikirim.');
    }
    ...
    public function riwayat(Request $request)
    {
        ...
        return view('atasan.izin.riwayat', [
    ...
    public function notifikasi()
    {
        ...
        return view('atasan.izin.notifikasi', ['notifications' => $notifications]);
    }
}