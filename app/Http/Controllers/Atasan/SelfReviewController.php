...
class SelfReviewController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($commitment->selfReview) {
            return view('atasan.self-review.edit', [
                'commitment' => $commitment,
                'review' => $commitment->selfReview,
            ]);
        }

        return view('atasan.self-review.create', ['commitment' => $commitment]);
    }
    ...
    public function store(Request $request)
    {
        ...
        // Kunci sebagai Actual Mingguan final
        ...
        return redirect()->route('atasan.dashboard')->with('status', 'Self Review berhasil disimpan. Data actual mingguan sudah terkunci.');
    }
    ...
    public function update(Request $request, SelfReview $review)
    {
        ...
        // Update juga Actual Mingguan-nya biar konsisten dan re-trigger Observer
