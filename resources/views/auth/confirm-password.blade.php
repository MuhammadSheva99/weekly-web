...
<head>
    ...
    <title>Konfirmasi Password - Weekly Performance Management</title>
    ...
    <div class="min-h-screen flex" x-data="{ showPassword: false }">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center bg-gray-800 px-6 py-12">
            <div class="w-full max-w-sm bg-white rounded-2xl shadow-xl p-8">
                ...
                <h1 class="text-2xl font-bold text-gray-900 text-center mb-1">Konfirmasi Password</h1>
                <p class="text-gray-500 text-center text-sm mb-6">
                    Ini area aman aplikasi. Masukkan password kamu untuk melanjutkan.
                </p>
                ...
                <form method="POST" action="{{ route('password.confirm') }}" class="space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <input :type="showPassword ? 'text' : 'password'" name="password" placeholder="Password" required autocomplete="current-password" autofocus
