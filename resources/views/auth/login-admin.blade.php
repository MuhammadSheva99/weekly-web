...
<head>
    ...
    <title>Login Admin - Weekly Performance Management</title>
...
<body class="antialiased">
    ...
    <div class="min-h-screen flex" x-data="{ showPassword: false }">
        ...
        {{-- KANAN: Form Login --}}
        <div class="w-full lg:w-1/2 flex items-center justify-center bg-orange-500 px-6 py-12">
                ...
                <form method="POST" action="{{ route('login.admin') }}" class="space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" placeholder="Email Address" required autofocus
                               value="{{ old('email') }}"
                               class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400">
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <input :type="showPassword ? 'text' : 'password'" name="password" placeholder="Password" required
                               class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400">
