...
@section('title', 'Riwayat Izin ' . $karyawan->nama)

@section('content')
    <a href="{{ route('hrd.izin-karyawan.riwayat', ['periode' => $periode]) }}" class="text-sm text-gray-500 hover:underline">← Kembali</a>

    <h1 class="text-3xl font-bold text-gray-900 mt-3">Riwayat Izin {{ $karyawan->nama }}</h1>
