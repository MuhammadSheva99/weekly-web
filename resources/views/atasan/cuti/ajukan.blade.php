...
@section('content')
    ...
    <form method="POST" action="{{ route('atasan.cuti.store') }}" enctype="multipart/form-data" class="space-y-6 max-w-xl">
        @csrf
        ...
        <div class="px-4 py-3 bg-red-50 text-red-700 rounded-lg text-sm">
            Pengajuan akan langsung diteruskan ke HRD untuk persetujuan (kamu tidak memiliki atasan langsung).
        </div>
