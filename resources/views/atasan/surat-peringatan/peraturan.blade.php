    ...
    @if ($dokumen)
        <div class="bg-white border border-gray-200 rounded-2xl p-6 mb-6 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center text-red-700 font-semibold text-xs">
                    DOC
                </div>
                <div>
            ...
            <a href="{{ Storage::url($dokumen->file_path) }}" target="_blank" class="px-4 py-2 bg-red-700 hover:bg-red-800 text-white rounded-lg text-sm font-medium">
                Unduh
            </a>
        </div>
