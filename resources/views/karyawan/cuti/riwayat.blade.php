            ...
            <tbody>
                @forelse ($riwayat as $c)
                    <tr class="border-b">
                        ...
                        <td class="py-3 pr-4 text-gray-600">{{ $c->disetujuiOleh->nama ?? $c->atasanApprovedBy->nama ?? '-' }}</td>
                        <td class="py-3 pr-4">
                            <span @class([
                                'px-2 py-1 rounded text-xs font-semibold',
                                'bg-orange-100 text-orange-700' => in_array($c->status, ['menunggu_atasan', 'menunggu_hrd']),
